...
The accuracy of a classification tree model is **`r round(cmRp$overall['Accuracy'],2)*100`%**.
...
The accuracy of a random forest model is **`r round(cmRf$overall['Accuracy'],2)*100`%**.
...
The accuracy of a boosted model is **`r round(cmGbm$overall['Accuracy'],2)*100`%**.

# Model Selection

The **random forest model** has the highest accuracy and will be selected.  The out of sample error is calculated by 1 - accuracy, which in this case is **`r round(1-cmRf$overall['Accuracy'],2)*100`%**.
